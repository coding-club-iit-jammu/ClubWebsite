            ...
            <div>
                <section className="dark">
                    <div className=" py-4">
                        ...
                        <EventCard secondCard={false} name="Introduction Machine Learning" type="Workshop" date="26 January 2023" desc="This was the second installment and a continuation of the previous session, conducted by Copetetive Programming Department." poster_img={poster7} duration="2 hrs" color="red   " name2="&nbsp; Codenite" type2="Contest" date2="4 January 2023" desc2="This was an intra institute level competitive programming contest organised by Coding Club which saw a masive participation." poster_img2={poster6} duration2="2 hrs" color2="red" />
